...
return [
    ...
    'settings.schema.type.default' => [
        ...
        'options' => [
            'Book' => _x('Book', 'admin-text', 'site-reviews'),
            'Course' => _x('Course', 'admin-text', 'site-reviews'),
            'CreativeWorkSeason' => _x('Creative Work Season', 'admin-text', 'site-reviews'),
            'CreativeWorkSeries' => _x('Creative Work Series', 'admin-text', 'site-reviews'),
            'custom' => _x('Custom', 'admin-text', 'site-reviews'),
            'Episode' => _x('Episode', 'admin-text', 'site-reviews'),
            'Event' => _x('Event', 'admin-text', 'site-reviews'),
            'Game' => _x('Game', 'admin-text', 'site-reviews'),
            'HowTo' => _x('How To', 'admin-text', 'site-reviews'),
            'LocalBusiness' => _x('Local Business', 'admin-text', 'site-reviews'),
            'MediaObject' => _x('Media Object', 'admin-text', 'site-reviews'),
            'Movie' => _x('Movie', 'admin-text', 'site-reviews'),
            'MusicPlaylist' => _x('Music Playlist', 'admin-text', 'site-reviews'),
            'MusicRecording' => _x('Music Recording', 'admin-text', 'site-reviews'),
            'Organization' => _x('Organization', 'admin-text', 'site-reviews'),
            'Product' => _x('Product', 'admin-text', 'site-reviews'),
            'Recipe' => _x('Recipe', 'admin-text', 'site-reviews'),
            'SoftwareApplication' => _x('Software Application', 'admin-text', 'site-reviews'),
        ],
        'type' => 'select',
    ],
